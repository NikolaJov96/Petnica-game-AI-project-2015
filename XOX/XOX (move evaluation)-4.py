...
class XOXGame():
    ...
    def makeMove(self, x, y):
        ...
        if not abledToWinn:
            ...
            if op == 0 and emp == 1: abledToBlock = True
        if not abledToWinn:
            pl = 0
            emp = 0
            op = 0
        ...
        opco = 0
        for i in range(3):
            if self.board[x][i] == pl: plco = plco + 1
        ...
        opco = 0
        for i in range(3):
            if self.board[i][y] == pl: plco = plco + 1
        ...
        if (x, y) in [(0,0), (1,1), (2,2)]:
            ...
            opco = 0
            for i in range(3):
                if self.board[i][i] == pl: plco = plco + 1
        ...
        if (x, y) in [(0,2), (1,1), (2,0)]:
            ...
            opco = 0
            for i in range(3):
                if self.board[i][2-i] == pl: plco = plco + 1
...
rews = {'win': 16.0, 'lose': -16.0, 'draw': 1.0, 'winpos': 0.0, 'block': 0.0}
